...
port = "/dev/ttyACM0"
gps_ser = serial.Serial(port, baudrate = 9600, timeout = 0.5)
...
try:
    while True:
        ...
        try:
            ...
            data = ser.readline()
            [lon,lat,dat] = gps_sensor.parseGPS(data.decode("utf-8"))
            print(dat)
...
#The interupt to plot the data
    ...
    combined_list = list(zip(ratio,rssi,snr,num,rep,num_byte_error,suc,all_ecc,all_timestamps,all_lon,all_lat))
