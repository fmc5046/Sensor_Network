...
def emitterConverter(size_par, data):
    """
...
def receptorConverter(size_par, data):
    """
...
print("Size of original is " + str(len(binaryText)))
print("\n --Message exchange--")
...
print("Data receive ------------> " + "".join(dataReceiv) + "\t\t -- Data integrity: " + str(ack))
print("\n --Force error--")
print("Data to send ------------> " + binaryText)
dataOut = emitterConverter(sizePari, binaryText)
print("Data converted ----------> " + "".join(dataOut))
